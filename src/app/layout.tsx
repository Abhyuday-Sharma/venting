...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Venting: Express. Release. Grow.',
    template: '%s | Venting',
  },
  ...
  authors: [{ name: 'Venting Team', url: 'https://venting.in' }],
  ...
  openGraph: {
    ...
    description: 'Join Venting, the anonymous emotional wellness platform. A safe, private, and supportive space to express your thoughts, track your mood, and heal together.',
...
const jsonLd = [
  ...
  },
  {
    ...
    alternateName: ['Venting.in'],
    url: 'https://venting.in',
    description: 'AI-powered anonymous emotional wellness platform. Express your thoughts, release what weighs you down, and grow through your emotions.',
    publisher: {
      '@type': 'Organization',
      name: 'Venting',
      logo: 'https://venting.in/og-image.png',
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="/venting_180.png" />
