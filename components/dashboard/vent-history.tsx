...
import { Trash2, Shield, EyeOff, Pencil, Lock } from "lucide-react";
...
export function VentHistory({ vents, onDeleteVent }: VentHistoryProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {writtenVents.map((vent) => (
        <Card key={vent.id} className="transition-all hover:shadow-md bg-card/50 backdrop-blur-sm relative group">
